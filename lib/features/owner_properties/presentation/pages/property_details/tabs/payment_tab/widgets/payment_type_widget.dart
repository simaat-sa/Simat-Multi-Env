...
class PaymentTypeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Text(model.expensesTypeAr,style: AppTextStyle.s14_w400(color: context.colors.darkTextColor),),
        Gaps.hGap4,
        Text(".",style: AppTextStyle.s16_w500(color: context.colors.primary),),
        Gaps.hGap4,
        Text(model.area,style: AppTextStyle.s14_w400(color: context.colors.darkTextColor),)
      ],
    );
  }
}
