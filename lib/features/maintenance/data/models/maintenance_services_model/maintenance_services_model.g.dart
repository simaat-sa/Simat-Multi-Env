...
_$MaintenanceServicesModelImpl _$$MaintenanceServicesModelImplFromJson(
    ...
    _$MaintenanceServicesModelImpl(
      ...
      code: json['list_code'] as String? ?? '0',
      value: json['list_val'] as String? ?? '0',
      nameAr: json['list_ar'] as String? ?? '',
      nameEn: json['list_en'] as String? ?? '',
      ...
      uuid: json['list_uuid'] as String? ?? '0',
...
Map<String, dynamic> _$$MaintenanceServicesModelImplToJson(
    ...
    <String, dynamic>{
      ...
      'list_ar': instance.nameAr,
      'list_en': instance.nameEn,
