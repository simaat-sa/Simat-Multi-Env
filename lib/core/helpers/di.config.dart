...
import 'package:flutter_tdd/core/helpers/firebase_analytics_helper.dart' as _i17;
...
import 'package:flutter_tdd/core/http/dio_helper/utils/dio_options.dart' as _i16;
import 'package:flutter_tdd/core/http/dio_helper/utils/handle_errors.dart' as _i22;
import 'package:flutter_tdd/core/http/dio_helper/utils/handle_json_response.dart' as _i23;
import 'package:flutter_tdd/core/http/dio_helper/utils/handle_request_body.dart' as _i24;
...
import 'package:flutter_tdd/features/auth/data/data_sources/auth_data_source.dart' as _i4;
import 'package:flutter_tdd/features/auth/data/data_sources/auth_data_source_impl.dart' as _i5;
import 'package:flutter_tdd/features/auth/data/repositories/auth_repository_impl.dart' as _i7;
import 'package:flutter_tdd/features/auth/domain/repositories/auth_repository.dart' as _i6;
import 'package:flutter_tdd/features/base/data/data_sources/home_remote_data_source.dart' as _i25;
import 'package:flutter_tdd/features/base/data/data_sources/impl_home_remote_data_source.dart'
    as _i26;
import 'package:flutter_tdd/features/base/data/repositories/impl_base_repository.dart' as _i9;
import 'package:flutter_tdd/features/base/domain/repositories/base_repository.dart' as _i8;
import 'package:flutter_tdd/features/contract/data/data_source/contract_data_source.dart' as _i10;
...
import 'package:flutter_tdd/features/contract/data/repositories/contract_repository_impl.dart'
    as _i13;
import 'package:flutter_tdd/features/contract/domain/repositories/contract_repository.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i17.FirebaseAnalyticsHelper>(() => _i17.FirebaseAnalyticsHelper());
    gh.lazySingleton<_i18.GenericHttpImpl<dynamic>>(() => _i18.GenericHttpImpl<dynamic>());
    ...
    gh.lazySingleton<_i23.HandleJsonResponse<dynamic>>(() => _i23.HandleJsonResponse<dynamic>());
    gh.lazySingleton<_i24.HandleRequestBody>(() => _i24.HandleRequestBody());
    gh.factory<_i25.HomeRemoteDataSource>(() => _i26.ImplHomeRemoteDataSource());
    gh.singleton<_i27.LoadingHelper>(_i27.LoadingHelper());
    gh.factory<_i28.LocationService>(() => _i28.LocationService());
    gh.factory<_i29.MaintenanceDataSource>(() => _i30.MaintenanceDataSourceImpl());
